...
4. 不要写成普通新闻摘要，要突出“为什么重要”和“对 AI PM 的启发”，但不要把同一信息拆成多个重复小段。
5. 内容要有信息密度，但不要太长，适合手机阅读。
6. 优先关注：模型发布、AI Agent、RAG、多模态、AI Coding、开源模型、AI 产品化、商业化、人员变动、组织调整、融资并购。
7. 同一事实、同一产品能力、同一公司动作只能讲一次；不要用不同说法反复解释同一件事。
8. 如果某条新闻已经进入“今日必看 Top 5”，后续板块不要重复描述，只能补充新的角度；没有新角度就跳过。
...
1. 标题：xxx
总结：用 3-5 句完整、连贯的话说明这条新闻。第 1 句说清楚发生了什么；第 2 句说明关键变化或差异点；第 3 句说明为什么重要；第 4 句说明对 AI 产品、开发者生态、商业化或行业趋势的启发；如信息足够，可用第 5 句补充风险、局限或后续观察。不要拆成 What / Why / AI PM，也不要重复标题。
原文：xxx
...
- 每条控制在 2-3 句话，只写没有在 Top 5 中详细展开过的信息，或补充一个新的观察角度。
- 无则写：今日暂无值得关注更新。
